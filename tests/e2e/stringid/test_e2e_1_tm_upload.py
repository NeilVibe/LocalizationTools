...
Run: python -m pytest tests/e2e/stringid/test_e2e_1_tm_upload.py -v
...
class TestTMUploadStringID:
    ...
    def test_tm_07_upload_txt_format(self):
        ...
        fixture_path = Path(__file__).parent.parent.parent / "fixtures" / "stringid" / "basic_stringid_data.txt"
    ...
    def test_tm_08_upload_xml_format(self):
        ...
        fixture_path = Path(__file__).parent.parent.parent / "fixtures" / "stringid" / "basic_stringid_data.xml"
        with open(fixture_path, 'rb') as f:
            xml_bytes = f.read()
