...
- [ ] **Phase 62: TM Auto-Update Pipeline** - Automatic embedding generation and incremental HNSW updates on every TM add/edit/batch import (gap closure in progress)
...
- [ ] 62-03-PLAN.md -- Gap closure: Add line-level FAISS persistence to InlineTMUpdater (Tier 4 fix)
...
| 62. TM Auto-Update Pipeline | v7.0 | 2/3 | Gap closure | - |
