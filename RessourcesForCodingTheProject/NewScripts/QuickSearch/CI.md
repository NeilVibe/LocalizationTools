# QuickSearch CI/CD Guide

## Build System: GitHub Actions

**Workflow:** `.github/workflows/quicksearch-build.yml`
**Trigger File:** `QUICKSEARCH_BUILD.txt` (at repo root)
...
|----------|-------------|
| `QuickSearch_vX.X.X_Setup.exe` | Installer (recommended) |
| `QuickSearch_vX.X.X_Portable.zip` | No-install version |
| `QuickSearch_vX.X.X_Source.zip` | Source code |
...
| File | Purpose |
|------|---------|
| `QuickSearch.spec` | PyInstaller configuration |
| `installer/QuickSearch.iss` | Inno Setup script |
