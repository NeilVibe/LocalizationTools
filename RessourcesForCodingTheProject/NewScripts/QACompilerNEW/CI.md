# QACompilerNEW CI/CD Guide

## Build System: GitHub Actions

**Workflow:** `.github/workflows/qacompiler-build.yml`
**Trigger File:** `QACOMPILER_BUILD.txt` (at repo root)
...
|----------|-------------|
| `QACompiler_vX.X.X_Setup.exe` | Installer (recommended) |
| `QACompiler_vX.X.X_Portable.zip` | No-install version |
...
| File | Purpose |
|------|---------|
| `QACompiler.spec` | PyInstaller configuration |
| `installer/QACompiler.iss` | Inno Setup script |
