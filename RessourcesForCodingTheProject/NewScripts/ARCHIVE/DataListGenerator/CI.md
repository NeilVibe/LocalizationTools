# DataListGenerator CI/CD Guide

## Build System: GitHub Actions

**Workflow:** `.github/workflows/datalistgenerator-build.yml`
**Trigger File:** `DATALISTGENERATOR_BUILD.txt` (at repo root)
...
|----------|-------------|
| `DataListGenerator_vX.X.X_Setup.exe` | Installer (recommended) |
| `DataListGenerator_vX.X.X_Portable.zip` | No-install version |
| `DataListGenerator_vX.X.X_Source.zip` | Source code |
...
| File | Purpose |
|------|---------|
| `DataListGenerator.spec` | PyInstaller configuration |
| `installer/DataListGenerator.iss` | Inno Setup script |
