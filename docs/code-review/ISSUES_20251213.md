...
**Fixed:** Commit e89db50 - added `needs: build-linux`
...
- **6 FIXED** - CI/CD job dependencies, env vars, deselects, admin user, GitHub sync, skipif timing
- **16 ACCEPTED** - All verified as correct implementation
