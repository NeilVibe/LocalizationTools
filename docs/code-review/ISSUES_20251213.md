...
- **9 FIXED** - CI/CD job dependencies, env vars, deselects, admin user, GitHub sync, skipif timing, missing test dirs, semantic version, set-output syntax
