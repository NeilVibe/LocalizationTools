...
**Deferred:** Full async TMManager refactor required (~430 lines + bulk_copy async). Scope:
- Convert TMManager class to async
- Create async bulk_copy_tm_entries
- Update 4 endpoints to use async db
- Estimated: 2-3 hours + testing
**Tracking:** Created P26_ASYNC_TM_REFACTOR task
...
**Deferred:** Part of DR4-001 - will be fixed together in async TMManager refactor.
...
- ✅ Group H: Scale Issues (4 fixed, 2 deferred)
