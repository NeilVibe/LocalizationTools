...
```
VERSION = "2512131540"        ← Manual update
SEMANTIC_VERSION = "1.4.0"    ← Manual update (different format!)
package.json: "1.4.0"         ← Manual update
installer.iss: "2512131540"   ← Manual update
```

After factorization:
```
VERSION = "25.1213.1540"      ← AUTO-GENERATED by pipeline
...
```
Build at 15:40 → 25.1213.1540
Build at 16:05 → 25.1213.1605
Build at 09:30 next day → 25.1214.0930
```
...
🎉 SUCCESS! All 5 critical files have version: 25.1213.1540
```
