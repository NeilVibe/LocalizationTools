# Origin: QuickTranslate/core/excel_io.py
...
def _merge_excel_strorigin_only(
    ...
    from ._config import get_config as _get_cfg
    ...
    if stringid_to_category:
        ...
        for c in corrections:
            ...
            if category in _get_cfg().SCRIPT_CATEGORIES:
...
def _merge_excel_stringid_only(
    ...
    from ._config import get_config as _get_cfg
    SCRIPT_CATEGORIES = _get_cfg().SCRIPT_CATEGORIES
    SCRIPT_EXCLUDE_SUBFOLDERS = _get_cfg().SCRIPT_EXCLUDE_SUBFOLDERS
    ...
    def _try_resolve_as_eventname(eventname_str):
        ...
        if not _en_resolver_loaded:
            ...
            try:
                ...
                _en_mapping = get_eventname_mapping(_get_cfg().EXPORT_FOLDER)
